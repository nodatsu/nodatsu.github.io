...
var data = new Array();
	...
	data.push({ position:new google.maps.LatLng(40.826431, 140.755521),content:'スマイル＆スプーンキッチンスタジオ',icon:"pin/pin_g.png"});		//スマイル＆スプーンキッチンスタジオ
	data.push({ position:new google.maps.LatLng(40.828121, 140.747416),content:'おもたか跡地',icon:"pin/pin_h.png"});							//おもだか跡地
