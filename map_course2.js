...
var data = new Array();
	...
	data.push({ position:new google.maps.LatLng(40.826805, 140.755738),content:'スマイル＆スプーンキッチンスタジオ',icon:"pin/pin_l.png"});			//スマイル＆スプーンキッチンスタジオ
	data.push({ position:new google.maps.LatLng(40.827382, 140.747660),content:'おもたか跡地',icon:"pin/pin_m.png"});		//おもだか跡地
