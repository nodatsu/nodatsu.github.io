...
var data = new Array();
	...
	data.push({ position:new google.maps.LatLng(40.826535, 140.760442),content:'旭橋',icon:"pin/pin_k.png"});		//旭橋
	data.push({ position:new google.maps.LatLng(40.826431, 140.755521),content:'スマイル＆スプーンキッチンスタジオ',icon:"pin/pin_l.png"});			//スマイル＆スプーンキッチンスタジオ
	data.push({ position:new google.maps.LatLng(40.828121, 140.747416),content:'おもたか跡地',icon:"pin/pin_m.png"});		//おもだか跡地
	data.push({ position:new google.maps.LatLng(40.825369, 140.746718),content:'太宰下宿跡地',icon:"pin/pin_n.png"});		//太宰下宿跡地
